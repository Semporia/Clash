...
rule-providers:
  ...
  China: {type: http, behavior: classical, path: ./Filter/China.yaml, url: https://raw.githubusercontent.com/Semporia/Clash-X/master/Filter/China.yaml, interval: 3600}

  Dler: {type: http, behavior: classical, path: ./Filter/Dler.yaml, url: https://raw.githubusercontent.com/Semporia/Clash-X/master/Filter/Dler.yaml, interval: 3600}
  ...
  Tencent: {type: http, behavior: classical, path: ./Filter/Tencent.yaml, url: https://raw.githubusercontent.com/Semporia/Clash-X/master/Filter/Tencent.yaml, interval: 3600}
